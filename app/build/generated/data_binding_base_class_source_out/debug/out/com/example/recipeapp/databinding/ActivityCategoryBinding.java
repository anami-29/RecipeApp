...
public final class ActivityCategoryBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvCatgeory;

  @NonNull
  public final TextView tittle;

  private ActivityCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView goback,
      @NonNull ConstraintLayout main, @NonNull RecyclerView rvCatgeory, @NonNull TextView tittle) {
    this.rootView = rootView;
    this.goback = goback;
    this.main = main;
    this.rvCatgeory = rvCatgeory;
    this.tittle = tittle;
  }
  ...
  public static ActivityCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rv_catgeory;
      RecyclerView rvCatgeory = ViewBindings.findChildViewById(rootView, id);
      if (rvCatgeory == null) {
        break missingId;
      }
      ...
      return new ActivityCategoryBinding((ConstraintLayout) rootView, goback, main, rvCatgeory,
          tittle);
    }
